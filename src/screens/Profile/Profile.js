...
import { RightButton } from '../../components/Header';
    ...
    return (
      <View style={styles.containerInfo}>
        <TextField
          ...
          tintColor={!nameError ? colors.primary : 'red'}
          labelTextStyle={{
            ...textStyles.Normal,
            paddingTop: scale(1),
          }}
        ...
        <TextField
          ...
          baseColor={colors.fontSecondColor}
          errorColor={colors.errorColor}
          tintColor={!phoneError ? colors.primary : 'red'}
          labelTextStyle={{
            ...textStyles.Normal,
            paddingTop: scale(1),
          }}
            ...
            <View style={[styles.formSubContainer]}>
              <View
                ...
                <View style={styles.imgContainer}>
                  {user.user_id.name && (
                    <TextDefault textColor={colors.primary} bold H1>
